...
const form = useForm({
    ...
    country: props.supplier.country ?? 'Bolivia',
    ...
    bank_cci: props.supplier.bank_cci ?? '',
    payment_method: props.supplier.payment_method ?? 'transferencia',
                    ...
                    <div class="p-6">
                        <form @submit.prevent="submit" class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div class="md:col-span-2 flex items-center justify-end gap-4">
                                <Link :href="route('suppliers.show', supplier.id)" class="text-sm text-gray-600 underline hover:text-gray-900">
                                    Cancelar
                                </Link>
